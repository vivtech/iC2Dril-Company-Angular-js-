...
import { LicenseHistory } from 'src/app/@core/models/license-history.model';
    ...
    ngOnInit() {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: object, callback) => {
                ...
                dataTablesParameters['filter'][0] = { column: 'company', data: this.companydata };
                console.log(dataTablesParameters);
                const responseData = this.companyService.licenseHistory( this.companydata, dataTablesParameters).pipe(first())
                    .subscribe(response => {
